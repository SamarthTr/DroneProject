...
import tagda_freq1 as freq1  # embedded python module
...
class tagda(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tagda")
...
def main(top_block_cls=tagda, options=None):
