...
import Flowgraph1_Centrefreqloop as Centrefreqloop  # embedded python module
import Flowgraph1_epy_module_1 as epy_module_1  # embedded python module



from gnuradio import qtgui

class Flowgraph1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Flowgraph1")
        ...
        # Blocks
        ##################################################
        self._freq_range = Range(70000000, 6000000000, 1000000, 70000000, 200)
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(10, [1024], freq, samp_rate)
        self.blocks_correctiq_0 = blocks.correctiq()
        self.analog_feedforward_agc_cc_0 = analog.feedforward_agc_cc(1024, 10.0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_feedforward_agc_cc_0, 0), (self.qtgui_time_sink_x_0, 0))
        ...
        self.connect((self.iio_pluto_source_0, 0), (self.analog_feedforward_agc_cc_0, 0))
...
def main(top_block_cls=Flowgraph1, options=None):
